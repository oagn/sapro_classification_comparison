...
try:
    ...
    print("Warning: NIQE could not be imported from skimage.metrics. NIQE scores will be NaN.")
    print("Consider updating scikit-image: pip install --upgrade scikit-image")
